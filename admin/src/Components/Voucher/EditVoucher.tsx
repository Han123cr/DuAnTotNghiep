...
const EditVoucher = () => {
        ...
        const fetchVoucherDetail = async () => {
            try {
                ...
                if (result) {
                    ...
                    setMinimumPrice(result.minimum)
                    setReducePrice(result.reduce)
                    setType(result.type)
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                console.log('Sửa ưu đãi thành công');
                ...
                console.error('Sửa ưu đãi thất bại');
                console.log(formData);
    ...
    return (
        <>
            <Button
                sx={{ marginBottom: '10px', left: '870px' }}
                variant="contained"
            ...
            <Snackbar open={successOpen} autoHideDuration={2000} onClose={handleClose}>
                <Alert
                    ...
                    sx={{ width: '100%' }}
                >
                    Sửa ưu đãi thành công! Đang chuyển hướng...
                </Alert>
            </Snackbar>
